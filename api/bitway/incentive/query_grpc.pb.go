...
const (
	Query_Params_FullMethodName      = "/bitway.incentive.Query/Params"
	Query_Rewards_FullMethodName     = "/bitway.incentive.Query/Rewards"
	Query_RewardStats_FullMethodName = "/bitway.incentive.Query/RewardStats"
)
