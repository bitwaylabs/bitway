...
type QueryDKGRequestsRequest struct {
	...
	Status     DKGStatus            `protobuf:"varint,2,opt,name=status,proto3,enum=bitway.tss.DKGStatus" json:"status,omitempty"`
...
var file_bitway_tss_query_proto_rawDesc = []byte{
	...
	0x2e, 0x62, 0x69, 0x74, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x73, 0x73, 0x2e, 0x44, 0x4b, 0x47, 0x53,
